...
# Task 22 adds the three button links without introducing list markup yet.
task22_path = ROOT / "22-index.html"
task22_text = task22_path.read_text(encoding="utf-8")
task22_text = task22_text.replace('<div><a href="#">Get started</a></div>', '<a href="#">Get started</a>')
task22_text = task22_text.replace('<a href="about.html">Learn more about us</a></div></section>', '</div><a href="about.html">Learn more about us</a></section>')
task22_text = task22_text.replace('<div><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id Sextilius factum negabat. Quo tandem modo? At eum nihili facit; Quae contraria sunt his, malane?</p><a href="contact.html">Get in touch</a></div></section>', '<div><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id Sextilius factum negabat. Quo tandem modo? At eum nihili facit; Quae contraria sunt his, malane?</p></div><a href="contact.html">Get in touch</a></section>')
task22_text = task22_text.replace('<div><ul>\n<li><a href="https://www.facebook.com/HolbertonSchool/">Facebook</a></li>\n<li><a href="https://twitter.com/holbertonschool">Twitter</a></li>\n<li><a href="https://www.instagram.com/holbertonschool/">Instagram</a></li>\n</ul></div>', '<div><a href="https://www.facebook.com/HolbertonSchool/">Facebook</a><a href="https://twitter.com/holbertonschool">Twitter</a><a href="https://www.instagram.com/holbertonschool/">Instagram</a></div>')
task22_path.write_text(task22_text, encoding="utf-8")