...
footer27 = '<footer>' + social + secondary + '<hr><p>© 2020 Techium, made with ♥ by students at Holberton School.</p></footer>'
write("29-index.html", page("Homepage - Techium", home_header + '<main><h1>Homepage</h1>' + sections + '</main>' + footer27))
footer31 = '<footer><address>234 Washington Street<br>Urbana, Illinois</address>' + social + secondary + '<hr><p>© 2020 Techium, made with ♥ by students at Holberton School.</p></footer>'
write("31-index.html", page("Homepage - Techium", home_header + '<main><h1>Homepage</h1>' + sections + '</main>' + footer31))
footer35 = '<footer><img src="logo-black.png" alt="Techium logo" width="160" height="40"><address>234 Washington Street<br>Urbana, Illinois</address>' + social + secondary + '<hr><p>© 2020 Techium, made with ♥ by students at Holberton School.</p></footer>'
