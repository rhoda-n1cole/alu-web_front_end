...
write("7-index.html", page("Homepage - Techium", '<header><nav></nav></header><main>' + semantic_sections + '</main><footer>Footer</footer>'))
write("8-index.html", page("Homepage - Techium", '<header><nav></nav></header><main><h1>Homepage</h1>' + semantic_sections + '</main><footer>Footer</footer>'))
